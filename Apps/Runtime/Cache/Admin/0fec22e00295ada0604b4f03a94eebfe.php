...
<div class="bodywrapper">
    ...
    <br /><br />
</div>            <div class="centercontent">                <div id="contentwrapper" class="contentwrapper">            <div class="contenttitle2">                <h3>编辑机器</h3>            </div><!--contenttitle-->        	            <div id="validation" class="subcontent">            	                    <form id="form1" class="stdform" method="post" action="">                    	<p>                        	<label>名称</label>                            <span class="field"><input type="text" name="firstname" id="firstname" class="longinput" value="aaaa"/></span>                        </p>                                                <p>                        	<label>编号</label>                            <span class="field"><input type="text" name="lastname" id="lastname" class="longinput" value="bbbb"/></span>                        </p>                                                <p>                        	<label>规格</label>                            <span class="field"><input type="text" name="email" id="email" class="longinput" value="cccc"/></span>                        </p>                                                <p>                        	<label>位置</label>                            <span class="field"><textarea cols="80" rows="5" name="location" class="mediuminput" id="location">dddddd</textarea></span>                         </p>                                                <p>                        	<label>选择</label>                            <span class="field">                            <select name="selection" id="selection">                            	<option value="">-请选择-</option>                                <option value="1" selected="selected">Selection One</option>                                <option value="2">Selection Two</option>                                <option value="3">Selection Three</option>                                <option value="4">Selection Four</option>                            </select>                            </span>                        </p>                                                <br />                                                <p class="stdformbutton">                        	<button type="submit" class="submit radius2">提交</button>                            <button type="button" class="backbutton" onclick="history.back()">返 回</button>                        </p>                    </form>            </div><!--subcontent-->                </div><!--contentwrapper-->        	</div><!-- centercontent -->        </div><!--bodywrapper--></body></html>