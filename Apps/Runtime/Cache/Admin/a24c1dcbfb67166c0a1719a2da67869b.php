    ...
    <div class="centercontent tables">
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div class="contenttitle2">
            	<h3>设备:<?php echo ($row["deviceNo"]); ?>消费流水</h3>
            </div><!--contenttitle-->
            ...
            <form name="form" id="form" method="POST" action="">
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb" id="tab">
                    ...
                    <?php if(!empty($rows)): if(is_array($rows)): $k = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($k % 2 );++$k;?><tr>
                            <td align="center">
                                <input type="checkbox" name="id[]" value="<?php echo ($i["consId"]); ?>" />
                            </td>
                            <td>
                                <?php if(($p) == ""): echo ($k); ?>
                                <?php else: ?>
                            ...
                            <td><?php echo ($i["consTime"]); ?></td>
                            <td class="center">
                                <a href="/easy-city/index.php/Admin/Machine/del/id/<?php echo ($i["deviceId"]); ?>" onclick="return confirm('确定要删除吗?')">删除</a></td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    <?php else: ?>
                        <tr><td colspan="6" align="center">暂无信息...</td></tr><?php endif; ?>
                    </tbody>
                </table>
