        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div class="tableoptions">
                <form method="GET" action="">
                    <label><input type="text" name="phone" id="phone" placeholder="手机号码" value="<?php echo ($phone); ?>" /></label> 
                    &nbsp;
            ...
            <form name="form" id="form" method="POST" action="/easy-city/index.php/Admin/User/del">
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb" id="tab">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1">品牌</th>
                            <th class="head0">性别</th>
                            <th class="head1">出生</th>
                    ...
                    <?php if(!empty($rows)): if(is_array($rows)): $k = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($k % 2 );++$k;?><tr>
                            ...
                            <td><?php echo ($i["userPhone"]); ?></td>
                            <td><?php echo ($i["carCode"]); ?></td>
                            <td><?php echo ($i["carBand"]); ?></td>
                            <td>
                                <?php if(($i["userSex"]) == "1"): ?>男
                                <?php else: ?>
                                女<?php endif; ?>
                            </td>
                            <td><?php echo ($i["userBirth"]); ?></td>
                            <td class="center">
                                <a href="/easy-city/index.php/Admin/User/record/phone/<?php echo ($i["userPhone"]); ?>">消费流水</a> / <a href="/easy-city/index.php/Admin/User/del/id/<?php echo ($i["userId"]); ?>" onclick="return confirm('删除后会将现有的消费记录一并删除,确定要删除吗?')">删除</a></td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    <?php else: ?>
                        <tr><td colspan="8" align="center">暂无信息...</td></tr><?php endif; ?>
                    </tbody>
                </table>
